...
# BaseStream and DecompressReader are vendored from CPython's _compression
# module. That module is private and gives no stability guarantee (it moved to
# compression._common._streams in 3.14), so we use our own copy on every
# Python version rather than importing it where it happens to exist.
